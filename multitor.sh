...
printf "\e[1;91mProblem with 1 or more, check output\e[0m\n" 
exit 1 
fi 
printf "\n" 
printf "\e[1;77m[*] All Tor connection running...\e[0m\n" 
printf "\e[1;91m[*] To Stop: ./multitor.sh --stop\e[0m\n" ย
sleep 2
}
...
pkill -f -2 "tor -f multitor/multitor1"; 
pkill -f -2 "tor -f multitor/multitor2"; 
pkill -f -2 "tor -f multitor/multitor3"; 
pkill -f -2 "tor -f multitor/multitor4"; 
pkill -f -2 "tor -f multitor/multitor5"
rm -rf /var/lib/tor1 /var/lib/tor2 /var/lib/tor3 /var/lib/tor3 /var/lib/tor4 /var/lib/tor5
printf "\e[1;92m[*] All Tor connection stopped.\e[0m\n"
}


case "$1" in --start) multitor ;; --stop) stoptor ;; *)
